...
function cards() {
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/list')
        .then(data => {
            data.forEach(({
                img,
                altimg,
...
function forms(formSelector, modalTimerId) {
    ...
    const message = {
        loading: 'images/form/spinner.gif',
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__.default)('.top__tab-item', '.top__tabcontent', '.top__tab-items', 'top__tab-item--active');
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.default)('[data-modal]', '.modal', modalTimerId);
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.bot__timer-items', '2021-04-31');
